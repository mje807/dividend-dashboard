...
export const stockAnalyses: StockAnalysis[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // HRL — 호멜 푸즈 (배당왕족주, 59년 연속)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ticker: "HRL",
    analyzedAt: "2026-03-12 08:49 KST",
    businessSummary: "호멜 푸즈는 스팸(SPAM), 제니오(Jennie-O), 플랜터스(Planters) 등 브랜드를 보유한 미국 식품 기업으로, 냉장식품·가공육·간편식 중심의 경기방어형 포트폴리오를 운영합니다. 소매 유통과 푸드서비스 채널을 동시에 활용하며, 안정적 현금흐름을 기반으로 장기 배당 성장을 이어온 배당 킹입니다.",
    coreProducts: [
      "SPAM 및 가공육 제품",
      "칠면조/단백질 식품(Jennie-O)",
      "견과·스낵(Planters) 및 간편식",
    ],
    geographicPresence: "미국 중심 매출 구조(북미 비중이 높고, 국제 사업은 보조적)",
    dividendStreakYears: 59,
    dividendCAGR5yr: null,
    dividendCAGR10yr: null,
    recentDividendGrowth: "최근에도 배당 인상은 지속했지만, 이익 압박 구간에서 인상 폭은 과거 고성장 구간 대비 둔화되는 흐름입니다.",
    dividendSafety: "watch",
    dividendSafetyReason: "배당성향 130.6%는 이익 대비 배당 부담이 높아 단기적으로 배당 커버리지 점검이 필요합니다.",
    moatTypes: [
      "brand",
      "intangible_assets",
      "cost_advantage",
    ...
    moatStrength: "narrow",
    moatNarrative: "호멜은 장수 브랜드와 유통 채널 관계를 통해 반복 구매를 유도하는 소비재형 해자를 보유합니다. 다만 원재료 가격과 단백질 사이클의 영향을 크게 받아 초과수익 지속성은 제한적이며, 해자 강도는 넓기보다 좁은 편으로 판단됩니다.",
    revenueGrowthTrend: "최근 매출은 구조적 고성장보다는 제품 믹스 개선과 정상화 회복에 의존하는 완만한 흐름입니다.",
    marginTrend: "contracting",
    debtLevel: "moderate",
    financialSummary: "PBR 1.60과 D/E 35.9는 과도한 레버리지 위험은 크지 않지만, ROE 6.1%로 수익성 효율은 낮은 편입니다. Trailing PER 26.2는 현재 이익 기준 부담이 있으나 Forward PER 14.6은 실적 정상화 기대를 반영합니다. 핵심은 향후 영업이익 회복으로 배당성향을 정상 범위로 되돌릴 수 있는지입니다.",
    keyRisks: [
      "원재료·사료비 변동 및 단백질 사이클로 인한 마진 압박",
      "높은 배당성향 지속 시 배당 성장률 둔화 또는 재무 유연성 저하",
      "소비 둔화/가격 경쟁 심화에 따른 브랜드 파워 약화 가능성",
    ],
    bullCase: "원가 정상화와 제품 믹스 개선이 동반되면 이익 회복 속도가 빨라지고, 높은 배당수익률과 멀티플 재평가가 동시에 나타날 수 있습니다. 52주 저점권에서의 리레이팅이 발생하면 목표가 상단 접근 가능성이 있습니다.",
    bearCase: "마진 회복이 지연되면 높은 배당성향이 장기화되어 배당 성장 매력은 약해질 수 있습니다. 이 경우 저평가처럼 보이는 구간에서도 주가가 장기간 박스권에 머물 수 있습니다.",
    valuationComment: "현재 배당수익률(5.01%)이 5년 평균(3.05%)을 크게 상회하고 52주 위치도 낮아 밸류에이션 매력은 존재합니다. 다만 높은 배당성향을 감안하면 분할 접근이 적절하며, 이익 회복 확인 전까지는 보수적 매수 구간(저 20달러대) 중심이 유리합니다.",
    recentDevelopments: [
      "애널리스트 컨센서스는 buy, 목표가 27.62달러로 약 19.9% 상승여력을 제시",
      "Forward PER이 Trailing PER 대비 크게 낮아 실적 정상화 기대가 반영되는 국면",
    ],
    overallRating: "관망",
    ratingReason: "수익률과 저점 메리트는 좋지만 배당성향이 높아 이익 회복 확인 전에는 보수적 접근이 합리적입니다.",
    targetBuyPrice: 22,
  },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // ASML — ASML (배당귀족주, 10년 연속)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ticker: "ASML",
    analyzedAt: "2026-02-26 08:36 KST",
    businessSummary: "ASML은 첨단 반도체 제조에 필수적인 노광(리소그래피) 장비를 사실상 독점적으로 공급하는 핵심 인프라 기업입니다. 특히 EUV 장비는 최선단 공정(3nm 이하) 양산의 병목 구간을 담당하며, 장비 판매 이후 서비스·업그레이드 매출이 반복적으로 발생하는 구조를 갖고 있습니다. 대형 파운드리와 메모리 업체의 설비투자 사이클에 직접 연동되는 고부가가치 B2B 모델입니다.",
    coreProducts: [
      "EUV 노광 장비",
      "DUV 노광 장비",
      "설치 기반 서비스·유지보수·업그레이드",
    ],
    geographicPresence: "아시아(대만·한국·중국) 비중이 가장 크고, 유럽·미국 대형 반도체 고객사로 매출이 분산된 글로벌 구조",
    dividendStreakYears: 10,
    dividendCAGR5yr: null,
    dividendCAGR10yr: null,
    recentDividendGrowth: "최근 3년 배당 CAGR 11.7%로 두 자릿수 배당 성장세를 유지하고 있습니다.",
    dividendSafety: "strong",
    dividendSafetyReason: "배당성향 26.6%로 낮고 ROE 50.5%로 수익성이 높아 이익 변동 구간에서도 배당 방어력이 우수합니다.",
    moatTypes: [
      "intangible_assets",
      "switching_costs",
      "efficient_scale",
    ...
    moatStrength: "wide",
    moatNarrative: "ASML의 핵심 해자는 EUV 관련 기술·특허·공정 노하우라는 무형자산에 기반합니다. 고객사는 장비 도입 후 공정·레시피·생산라인이 깊게 결합되어 전환비용이 매우 높습니다. 또한 극소수 공급자만 성립 가능한 시장 구조라 규모의 경제와 진입장벽이 동시에 작동합니다.",
    revenueGrowthTrend: "중장기적으로 AI/HPC 수요에 따른 선단 공정 투자 확대로 성장 추세는 우상향이나, 단기적으로는 고객 CAPEX 사이클에 따라 변동성이 큽니다.",
    marginTrend: "stable",
    debtLevel: "low",
    financialSummary: "ROE 50.5%와 낮은 배당성향은 자본 효율성과 현금배분 여력을 동시에 보여줍니다. D/E 13.8은 대차대조표 부담이 낮은 편으로 해석 가능하며, 재무 레버리지 리스크는 제한적입니다. 다만 높은 밸류에이션 구간에서는 실적 미스 시 주가 민감도가 커질 수 있습니다.",
    keyRisks: [
      "반도체 설비투자 사이클 둔화 시 수주·매출 변동성 확대",
      "미중 갈등 및 수출규제 강화에 따른 지역 매출 제약",
      "초고밸류에이션 구간에서 실적/가이던스 하향 시 멀티플 압축 위험",
    ],
    bullCase: "AI 수요 확대로 선단 공정 전환이 가속되면 EUV/하이-NA 장비 출하가 중장기 실적 레벨업을 견인할 수 있습니다. 낮은 배당성향과 높은 이익창출력은 배당 성장과 자사주 매입의 동시 지속 가능성을 높입니다.",
    bearCase: "고객사의 투자 지연이 길어지면 수주 공백과 밸류에이션 디레이팅이 동시에 발생할 수 있습니다. 현재 주가가 고점권에 가까워 작은 실적 둔화에도 하방 변동성이 커질 수 있습니다.",
    valuationComment: "Trailing PER 52.3, Forward PER 34.7, PBR 25.51은 프리미엄이 매우 높은 구간이며 52주 위치 97.9%로 가격 부담이 큽니다. 배당수익률도 0.59%로 5년 평균 0.82% 대비 낮아 배당 관점의 진입 매력은 제한적입니다. 분할 접근 기준으로는 멀티플 정상화가 반영되는 조정 구간에서의 매수가 유리합니다.",
    recentDevelopments: [
      "애널리스트 컨센서스는 buy지만 목표가(1487.44달러)가 현재가를 소폭 하회해 단기 기대수익률은 제한적입니다.",
      "AI·선단공정 투자 기대가 유지되며 장기 성장 스토리는 유효하나, 주가는 이미 상당 부분 선반영된 상태입니다.",
    ],
    overallRating: "관망",
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // ADP — 오토매틱 데이터 프로세싱 (배당귀족주, 50년 연속)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ticker: "ADP",
    analyzedAt: "2026-03-12 08:49 KST",
    businessSummary: "ADP는 기업의 급여 처리, 세무 신고, 복리후생 관리, 인사(HCM) 운영을 클라우드 기반으로 제공하는 글로벌 HR 테크 기업입니다. 대기업용 Employer Services와 중소기업용 PEO(고용대행) 서비스를 통해 반복적이고 규제 민감한 백오피스 업무를 아웃소싱해 줍니다. 경기 변동에도 급여·세무 업무의 필수성이 높아 비교적 방어적인 현금흐름을 창출하는 구조입니다.",
    coreProducts: [
      "급여(Payroll) 처리 및 세무/규정 준수 서비스",
      "HCM 소프트웨어(인사·근태·인재관리)",
      "PEO/HR 아웃소싱(복리후생·노무 행정 통합)",
    ],
    geographicPresence: "미국 중심(대부분) · 국제(유럽/캐나다/기타) 비중은 상대적으로 제한적",
    dividendStreakYears: 50,
    dividendCAGR5yr: null,
    dividendCAGR10yr: null,
    recentDividendGrowth: "최근 3년 배당 CAGR 13.1%로 고배당 성장 기조를 유지하고 있으며, 50년 연속 배당 증가 기록을 이어가고 있습니다.",
    dividendSafety: "strong",
    dividendSafetyReason: "배당성향 60.7%는 성숙 우량 서비스 기업 기준에서 관리 가능한 수준이며, 반복 매출 기반의 현금창출력이 배당 지속성을 뒷받침합니다.",
    moatTypes: [
      "switching_costs",
      "intangible_assets",
      "efficient_scale",
    ...
    moatStrength: "wide",
    moatNarrative: "급여·세무 시스템은 고객사 ERP/회계/복리후생 프로세스와 깊게 통합되어 전환비용이 높습니다. 규정 준수 노하우와 브랜드 신뢰는 무형자산 성격의 진입장벽으로 작동합니다. 대규모 처리 인프라와 운영 데이터 축적은 규모의 경제를 강화해 후발주자의 추격을 어렵게 만듭니다.",
    revenueGrowthTrend: "완만하지만 일관된 중단기 성장 추세로, 고용·임금·고객 유지율에 연동되는 구조입니다.",
    marginTrend: "stable",
    debtLevel: "moderate",
    financialSummary: "ROE 73.8%는 매우 높지만 자본 구조와 자사주/무형요인 영향이 반영된 수치로 해석이 필요합니다. D/E 70.0, PBR 13.43은 자본집약 업종 대비 높아 보이나, ADP는 자산경량형 서비스 모델 특성상 절대 수치만으로 과도한 위험을 단정하긴 어렵습니다. 전반적으로 수익성·현금흐름은 견조하나 밸류에이션과 금리 환경 민감도를 함께 점검해야 합니다.",
    keyRisks: [
      "고용시장 둔화 시 급여 처리 건수 감소로 성장률 둔화 가능성",
      "규제/세법 변경에 따른 시스템 투자 및 컴플라이언스 비용 증가",
      "높은 멀티플 구간에서 금리 상승 또는 실적 미스 발생 시 밸류에이션 조정 리스크",
    ],
    bullCase: "배당수익률이 5년 평균 대비 크게 높은 3.13%이고 주가가 52주 저점권(7.7%)에 근접해 밸류 부담이 완화되었습니다. 고용 안정과 PEO 확장, 운영 레버리지 회복이 맞물리면 배당 성장과 함께 리레이팅 여지가 있습니다.",
    bearCase: "경기 둔화로 고용·임금 증가율이 약해지면 매출 성장과 이익 모멘텀이 동시에 둔화될 수 있습니다. hold 중심의 컨센서스가 유지되는 가운데 멀티플 재평가가 지연되면 주가 회복 속도는 제한될 수 있습니다.",
    valuationComment: "현재 주가는 Forward PER 17.8, 저점권 위치, 평균 대비 높은 배당수익률을 감안하면 역사적 체감 밸류는 매력 구간에 근접해 보입니다. 다만 구조적 프리미엄 종목 특성상 분할 매수가 유효하며, 200달러 안팎 이하에서 기대수익/안전마진이 더 좋아지는 구간으로 판단됩니다.",
    recentDevelopments: [
      "배당수익률이 5년 평균(1.98%) 대비 크게 상회하며 소득형 투자 매력이 개선됨",
      "애널리스트 목표가 272달러(상승여력 27.7%) 제시에도 투자의견은 hold로, 실적 확인 이후 재평가 기대가 공존",
    ],
    overallRating: "관심",
    ratingReason: "배당 퀄리티와 해자는 우수하고 저점권 가격 메리트가 생겼지만, 성장 둔화·멀티플 변수 확인이 필요해 적극 매수보다는 관심 관찰이 적절합니다.",
    targetBuyPrice: 205,
  },

  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // O — 리얼티 인컴 (배당귀족주, 32년 연속)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ticker: "O",
    analyzedAt: "2026-03-12 08:49 KST",
    businessSummary: "리얼티 인컴(O)은 단일 임차인 순임대(NNN) 구조의 상업용 부동산에 투자하는 리츠로, 장기 임대계약을 통해 임차인이 세금·보험·유지보수 비용을 부담하는 모델을 운영합니다. 편의점, 달러스토어, 식료품, 약국 등 경기방어적 업종 중심의 테넌트 포트폴리오를 바탕으로 안정적인 임대수익과 월배당을 제공하는 것이 핵심입니다.",
    coreProducts: [
      "단일 임차인 NNN 상업용 부동산 임대",
      "세일즈앤리스백 기반 부동산 투자",
      "월배당 중심 주주환원",
    ],
    geographicPresence: "미국 중심(대부분) · 유럽 등 국제 비중은 보완적 수준",
    dividendStreakYears: 32,
    dividendCAGR5yr: null,
    dividendCAGR10yr: null,
    recentDividendGrowth: "32년 연속 배당 증가를 이어가며 최근 3년 기준 배당 CAGR은 8.2%로 견조합니다.",
    dividendSafety: "moderate",
    dividendSafetyReason: "배당 이력은 매우 우수하지만, 순이익 기준 배당성향이 275.5%로 높고 금리·조달비용 민감도가 있어 안전성은 중간 수준입니다.",
    moatTypes: [
      "cost_advantage",
      "efficient_scale",
      "intangible_assets",
    ...
    moatStrength: "narrow",
    moatNarrative: "대형 리츠로서 자본시장 접근성과 규모의 경제를 활용해 자산 편입 경쟁력을 확보하고 있습니다. 장기 NNN 계약과 분산된 임차인 기반은 현금흐름 변동성을 낮추는 구조적 장점입니다. 다만 부동산·금리 사이클 영향이 커 해자는 넓기보다 좁은 편으로 판단됩니다.",
    revenueGrowthTrend: "인수·개발 및 임대료 갱신을 통한 완만한 성장 추세입니다.",
    marginTrend: "stable",
    debtLevel: "high",
    financialSummary: "PBR 1.53은 자산가치 대비 과열 구간은 아니지만, D/E 73.5와 높은 배당성향은 재무 유연성을 제약할 수 있습니다. ROE 2.7%로 수익성은 높지 않으며, 리츠 특성상 금리 수준이 현금흐름과 밸류에이션에 직접적으로 작용합니다. 전반적으로 안정적 운영 기반은 있으나 레버리지 부담을 함께 점검해야 합니다.",
    keyRisks: [
      "고금리 장기화로 인한 조달비용 상승 및 밸류에이션 압박",
      "소매·상업용 임차인 신용 악화 시 공실/임대료 회수 리스크",
      "배당성향 과다 지속 시 배당 성장 둔화 가능성",
    ],
    bullCase: "금리 하향 사이클이 본격화되면 리츠 멀티플 재평가와 자본조달 여건 개선이 동시에 나타날 수 있습니다. 방어적 테넌트 구성과 월배당 매력으로 재유입 수요가 커지면 총수익률이 개선될 여지가 있습니다.",
    bearCase: "금리가 높은 수준에서 오래 유지되면 차환비용 부담과 자산 취득 스프레드 축소가 이어질 수 있습니다. 이 경우 배당 성장률 둔화와 주가 박스권 장기화 가능성이 큽니다.",
    valuationComment: "현재 배당수익률(4.99%)이 5년 평균(4.99%)과 동일하고, 52주 위치 81.3% 및 목표가 상승여력 3.2%를 감안하면 대체로 적정가~소폭 부담 구간입니다. 신규 매수는 안전마진 확보를 위해 수익률이 평균 대비 유의미하게 높아지는 가격대에서 분할 접근이 유리합니다.",
    recentDevelopments: [
      "금리 인하 기대와 장기채 금리 변동에 따라 리츠 전반의 밸류에이션 변동성이 확대됨",
      "애널리스트 컨센서스는 hold이며 목표가 기준 단기 기대수익은 제한적",
    ],
    overallRating: "보유",
    ratingReason: "배당 연속성은 최상위지만 현재 주가 메리트와 단기 업사이드가 제한적이어서 기존 보유 유지가 합리적입니다.",
    targetBuyPrice: 60,
  },
];
