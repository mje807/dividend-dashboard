...
export const stockAnalyses: StockAnalysis[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ticker: "ESS",
    analyzedAt: "2026-02-26 08:20 KST",
    businessSummary: "에섹스 프로퍼티 트러스트(ESS)는 미국 서부 해안의 고소득·고진입장벽 도시권에 집중해 아파트 자산을 보유·운영하는 주거형 리츠입니다. 임대료 수익을 기반으로 현금흐름을 창출하고, 개발·재개발·자산 리사이클링을 통해 장기 주주가치와 배당 성장을 추구합니다.",
    coreProducts: [
      "미국 서부 해안 멀티패밀리(아파트) 임대 운영",
      "아파트 개발·재개발 및 밸류애드",
      "부동산 자산 매입·매각(포트폴리오 리밸런싱)",
    ],
    geographicPresence: "미국 100% (주로 캘리포니아·시애틀 등 서부 해안 대도시권)",
    dividendStreakYears: 31,
    dividendCAGR5yr: null,
    dividendCAGR10yr: null,
    recentDividendGrowth: "31년 연속 배당 증가를 이어가고 있으며, 최근 3년 배당 CAGR은 13.1%로 배당 성장 모멘텀이 확인됩니다.",
    dividendSafety: "moderate",
    dividendSafetyReason: "장기 배당 트랙레코드는 강점이지만 배당성향 98.8%와 높은 레버리지(D/E 119.4)로 안전마진은 제한적입니다.",
    moatTypes: [
      "efficient_scale",
      "intangible_assets",
    ],
    moatStrength: "narrow",
    moatNarrative: "ESS의 해자는 공급 제약이 큰 서부 해안 핵심 주거 시장에 집중한 포트폴리오에서 나옵니다. 지역 운영 노하우, 인허가·입지·개발 실행 역량 같은 무형자산이 경쟁우위를 보강하지만, 금리·지역 경기 민감도가 높아 해자의 폭은 제한적입니다.",
    revenueGrowthTrend: "임대료 정상화와 점진적 임대수요 회복에 따라 중저단일 자릿수의 완만한 성장 추세가 기대됩니다.",
    marginTrend: "stable",
    debtLevel: "high",
    financialSummary: "ROE 12.2%로 수익성은 리츠 내에서 무난한 편이나, 배당성향 98.8%는 배당 여력 측면에서 보수적 접근이 필요합니다. D/E 119.4로 금리 환경 변화에 대한 민감도가 높아 재무 레버리지 관리가 핵심입니다. 현재 주가는 52주 밴드 하단(22.8%)에 위치해 밸류에이션 부담은 일부 완화된 상태입니다.",
    keyRisks: [
      "고금리 장기화로 인한 자본비용 상승 및 밸류에이션 압박",
      "서부 해안 특정 지역 집중에 따른 지역 경기·정책 리스크",
      "높은 배당성향으로 인한 배당 성장 둔화 또는 여력 축소 가능성",
    ],
    bullCase: "금리 하락 국면에서 리츠 멀티플이 재평가되고, 서부 해안 임대수요 회복이 이어지면 목표주가(상승여력 8.3%) 이상으로의 업사이드가 열릴 수 있습니다. 높은 평균 대비 배당수익률도 총수익률 개선에 기여할 수 있습니다.",
    bearCase: "금리 고착화와 운영비 상승이 동시에 나타나면 FFO 성장 둔화와 배당 커버리지 압박이 커질 수 있습니다. 이 경우 낮은 52주 위치에도 불구하고 주가 반등이 지연될 수 있습니다.",
    valuationComment: "현재 배당수익률(3.99%)이 5년 평균(3.44%)을 상회하고 52주 하단에 가까워 역사적 관점의 가격 메리트는 있습니다. 다만 높은 배당성향과 레버리지를 감안하면 분할 접근이 적절하며, 보다 보수적인 매수 구간은 240~250달러대로 판단됩니다.",
    recentDevelopments: [
      "현재 주가가 52주 범위 하단권(22.8%)에 위치해 리츠 섹터 내 상대적 저점 인식이 형성됨",
      "애널리스트 컨센서스는 hold이며 목표가 281.38달러로 제한적 업사이드를 제시",
    ],
    overallRating: "보유",
    ratingReason: "배당 연속성·입지 경쟁력은 우수하지만 높은 배당성향과 부채 부담으로 신규 매수는 가격 메리트 구간에서 신중한 분할 접근이 적절합니다.",
    targetBuyPrice: 245,
  },
