...
export const portfolioSummary: PortfolioSummary = {
  totalAsset: "백테스팅 →",
  annualDividend: "투자 배당률",
  dividendYield: "자산 구성",
  investDividendYield: "시가 배당률",
  totalReturn: "0",
...
export const holdings: Holding[] = [
  {
    ...
    currentPrice: 13285,
    dividendYield: 3.5,
    annualDividendPerShare: 464.98,
    dividendFrequency: "monthly",
    sector: "ETF",
    color: "hsl(0, 70%, 60%)",
    rawValue: "₩8,954,090",
    rawGain: "+₩1,708,213 (+23.57%)",
    currency: "KRW",
  },
  {
    ticker: "ACE 배당다우",
